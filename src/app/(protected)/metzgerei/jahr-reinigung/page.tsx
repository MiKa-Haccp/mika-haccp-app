...
function getYearRef(dateStr: string): string {
  const d = new Date(dateStr);
  return String(d.getFullYear()); // z.B. "2025"
}

export default function MetzgereiJahrReinigungFormPage() {
  ...
  async function onSubmit(e: React.FormEvent) {
    ...
    const periodRef = getYearRef(date);
    ...
    try {
      ...
      console.error("jahr-reinigung save error", err);
      setStatus("error");
  ...
  return (
    <main className="p-6">
      <h1 className="text-xl font-bold mb-2">
        Metzgerei · jährliche Reinigung
      </h1>
      <p className="text-sm opacity-70 mb-4">
        Erfassung der jährlichen Hauptreinigung für die Metzgerei.
      </p>
      ...
      >
        ...
        <label className="text-sm block">
          ...
          <textarea
            ...
            placeholder="z.B. komplette Jahresgrundreinigung …"
          />
        </label>
